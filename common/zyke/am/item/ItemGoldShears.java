...
public class ItemGoldShears extends Item {

	public ItemGoldShears(int id, int maxStackSize, CreativeTabs tab, String name) {
		 super(id);
	     ...
	     if (entity instanceof IShearable)
	     {
	         ...
	         if (target.isShearable(itemstack, entity.worldObj, (int)entity.posX, (int)entity.posY, (int)entity.posZ))
	         {
	             ...
	             for(ItemStack stack : drops)
	             {
	                 ...
	                 EntityItem ent3 = entity.entityDropItem(stack, 1.0F);
	                 EntityItem ent4 = entity.entityDropItem(stack, 1.0F);
	                 ...
	                 ent3.motionY += rand.nextFloat() * 0.05F;
	                 ent3.motionX += (rand.nextFloat() - rand.nextFloat()) * 0.1F;
	                 ent3.motionZ += (rand.nextFloat() - rand.nextFloat()) * 0.1F;
	                 ent4.motionY += rand.nextFloat() * 0.05F;
	                 ent4.motionX += (rand.nextFloat() - rand.nextFloat()) * 0.1F;
	                 ent4.motionZ += (rand.nextFloat() - rand.nextFloat()) * 0.1F;
	             }
